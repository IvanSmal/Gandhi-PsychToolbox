function [mh]=StationaryTargsIn(mh)
...
if ~mh.trialstarted
    ...
    T1_Stationary=mh.gettarg('T1_Stationary');
...
if mh.checkstate('delay_state')
    mh.Screen('FillOval', mh, mh.trialtarg('T1_Stationary','getcolor'),mh.trialtarg('T1_Stationary','getpos'));
    mh.Screen('FillOval', mh, mh.trialtarg('T0','getcolor'),mh.trialtarg('T0','getpos'));
    % mh.plotwindow('T0', mh.trialtarg('T0','getpos')); 
    % mh.plotwindow('T1_Stationary',mh.trialtarg('T1_Stationary','getpos')) ;
...
if mh.checkstate('T1_reach_state_stationary')
    ...
    if mh.checkint('T1_reach_state_stationary','T1_Reach') && ~mh.checkeye('T1_Stationary')
       % just chill
    elseif ~mh.checkeye('T1_Stationary')
        mh.stoptrial(0);
    elseif mh.checkint('T1_reach_state_stationary','T1_Reach') && mh.checkeye('T1_Stationary')
...
if mh.checkstate('T1_hold_state_stationary')
    ...
    if mh.checkint('T1_hold_state_stationary','T1_Hold') && mh.checkeye('T1_Stationary')
       % just chill
    elseif mh.checkint('T1_hold_state_stationary','T1_Hold') && ~mh.checkeye('T1_Stationary')
        mh.stoptrial(0);
    elseif ~mh.checkint('T1_hold_state_stationary','T1_Hold') && mh.checkeye('T1_Stationary')
